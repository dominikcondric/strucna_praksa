                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label for="admin" style="margin-right: 5px"><big>{{ "Yes" }}</big></label><input type="radio" name="admin" value="1" style="margin-right: 40px; margin-top: 10px">
                                <label for="admin" style="margin-right: 5px"><big>{{ "No" }}</big></label><input type="radio" value="0" checked="checked" name="admin">
                            </div>
                        </div>
